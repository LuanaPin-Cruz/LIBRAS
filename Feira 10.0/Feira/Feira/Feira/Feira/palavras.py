...
class PalavrasWindow(QWidget):
    def __init__(self, stacked, cursor_label, main_window, caminho_pasta):
        ...
        self.box.setStyleSheet("""
            QLabel {
                background: #ffffff;   /* cor da caixa */
                border-radius: 20px;
            }
        """)
        ...
        main_layout.setContentsMargins(100, 40, 80, 80)
        spacing = 280
        ...
        titulo = QLabel("PALAVRAS", self.box)
        ...
        video_widget.setStyleSheet("""
            ...
            border-radius: 15px;
        """)
        video_widget.setFixedSize(580, 450)

        video_layout = QVBoxLayout(video_widget)
        video_layout.setContentsMargins(0, 50, 0, 0)
        ...
        """)
        self.chat_box.setFixedSize(400, 400)
