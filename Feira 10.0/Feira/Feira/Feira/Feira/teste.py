...
class TesteWindow(QWidget):
    def __init__(self, stacked, cursor_label, main_window, caminho_pasta):
        ...
        self.cam.setGeometry(300, 160, 700,
                             400)  # AJUSTADO: Altura reduzida para 600px (deixa espaço abaixo para o botão)
        self.cam.setStyleSheet("""
            background-color: transparent;  /* Transparente para mostrar o vídeo da câmera; mude para #071829 se quiser fundo azul */
            border: none
        """)
        self.cam.show()
        # ========== FIM DA CÂMERA ==========
        ...
        titulo.setGeometry(0, 40, 1286, 80)   # largura total da janela
        ...
        self.button_back.setGeometry(475, 600, 373,
